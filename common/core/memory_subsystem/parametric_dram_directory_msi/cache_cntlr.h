...
//------------------------CAche ALoocated in mastercntlr
   ...
   class CacheMasterCntlr
   {
	 ...
	 SlabCntlr *m_slab_cntlr;
         ...
         {    
		PRAK_LOG("CAche master cntlrs constr called cache null");
	 }
         ~CacheMasterCntlr();
...
SharedCacheBlockInfo* insertCacheBlock_slab(IntPtr address, CacheState::cstate_t cstate, Byte* data_buf, core_id_t requester, ShmemPerfModel::Thread_t thread_num,core_id_t m_core_id);
         ...
         HitWhere::where_t processShmemReqFromPrevCache(core_id_t m_core_id,CacheCntlr* requester, Core::mem_op_t mem_op_type, IntPtr address, bool modeled, bool count, Prefetch::prefetch_type_t isPrefetch, SubsecondTime t_issue, bool have_write_lock);
      ...
      public:
         ...
         HitWhere::where_t processMemOpFromCore(core_id_t m_core_id,
