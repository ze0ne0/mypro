...
class CacheCntlr
{
   public:
	...
	virtual void slab_transfer(core_id_t core_id,UInt32 slot_index,UInt32 src_slab,UInt32 dst_slab)=0;	
	virtual void slab_transfer_off(core_id_t core_id,UInt32 slot_index,UInt32 src_slab,UInt32 dst_slab)=0;	
/*
